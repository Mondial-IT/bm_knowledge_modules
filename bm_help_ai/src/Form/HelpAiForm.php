...
class HelpAiForm extends FormBase {
  ...
  protected function buildActions(array $item): array {
    ...
    $display_url = Url::fromRoute('bm_help_ai.taxonomy_term_display', ['taxonomy_term' => $term_id]);
    ...
    return [
      ...
      '#links' => [
        'display' => [
          ...
          'url' => $display_url,
          'attributes' => array_merge_recursive($dialog_attributes, [
            'class' => ['bm-help-ai-display'],
          ]),
        ],
        'edit' => [
          'title' => $this->t('Edit'),
